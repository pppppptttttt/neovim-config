-- Main LSP configuration (nvim-lspconfig + mason)
...
return {
  ...
  config = function()
    -- LSP keymaps + highlighting on attach
    ...
    -- Diagnostic config
    -- IMPORTANT: sign text must be short (Neovim validates it). Use single glyphs / single letters.
